...
module Api
  module V1
    module Posts
      class PostTranscriptionsControllerTest < ActionDispatch::IntegrationTest
        ...
        context "#show" do
          test "works for org admin" do
            sign_in @user
            get organization_post_attachment_transcription_path(@organization.slug, @post.public_id, @attachment.public_id)
          ...
          test "returns 404 when the attachment is missing" do
            ...
            sign_in other_member.user
            get organization_post_attachment_transcription_path(@organization.slug, @post.public_id, "missing")
